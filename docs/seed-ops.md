...
| -------------------------------------- | ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| Catalog packages (+ optional bookings) | `pnpm db:seed:catalog` / `pnpm db:seed:catalog:neon` | Upsert paket Umrah by slug; hapus legacy leisure slug; booking hanya jika `SEED_INCLUDE_BOOKINGS=1` **dan** tabel booking kosong | Butuh `DATABASE_URL`          |
