...
export default function CustomerDetailPage() {
  ...
  useEffect(() => {
    document.title = `${customerName} - ${t("customers.title")} - Rihla Mate`;
  }, [t, customerName]);

  const bookingsQuery = useQuery(
    trpc.customers.getBookings.queryOptions({
      customerName,
      customerEmail,
      page,
      limit: PAGE_SIZE,
      ...
      <div className="px-4 lg:px-8 py-6">
        ...
        {!bookingsQuery.isLoading && !bookingsQuery.isError && bookings.length === 0 && (
          <div className="bg-card border border-border rounded-lg p-12 text-center">
            <p className="text-muted-foreground">{t("customers.noBookings")}</p>
          </div>
        )}
          ...
          <div className="bg-card border border-border rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-border">
              <p
                ...
                data-testid="customer-bookings-page-info"
              >
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  data-testid="customer-bookings-prev-page"
                ...
                <Button
                  ...
                  onClick={() => setPage((p) => p + 1)}
                  data-testid="customer-bookings-next-page"
